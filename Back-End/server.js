...
const _ContactUsManagementRoutes = require('./routes/ContactUsManagementRoute');
const imagesManagementRoutes = require('./routes/dummyManagementRoute')
...
app.use('/imagesManagement',imagesManagementRoutes)
//*****UsingRoutes*****//
